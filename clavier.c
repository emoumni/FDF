...
/*   Updated: 2023/05/22 14:47:05 by emoumni          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_reset(t_fdf *env)
{
	...
	if (env->camera->iso)
	{
		...
		env->camera->y_angle = -0.463647609;
...
{
	if (keycode == MINUS)
		env->camera->z_height += 0.2;
	else if (keycode == PLUS)
		env->camera->z_height -= 0.2;
	if (env->camera->z_height < 0.2)
		env->camera->z_height = 0.2;
...
static void	ft_translate(int keycode, t_fdf *env)
{
	if (keycode == ARROW_LEFT)
		env->camera->x_offset -= 7;
	else if (keycode == ARROW_RIGHT)
		env->camera->x_offset += 7;
	else if (keycode == ARROW_DOWN)
		env->camera->y_offset += 7;
